...
const ResultsListItem: FC<PlanetCharacteristics> = ({
  name,
  rotationPeriod,
  orbitalPeriod,
  diameter,
    ...
    <div className={classes.ResultsListItem}>
      <div className={classes.item}>
        ...
        <div className={classes.col2}>
          <div className={classes.row}>
            <div className={classes.rowCol1}>Rotation period</div>
            <div className={classes.rowCol2}>{rotationPeriod}</div>
          </div>
          <div className={classes.row}>
            <div className={classes.rowCol1}>Orbital period</div>
            <div className={classes.rowCol2}>{orbitalPeriod}</div>
          </div>
          <div className={classes.row}>
            <div className={classes.rowCol1}>Diameter</div>
            <div className={classes.rowCol2}>{diameter}</div>
          </div>
          <div className={classes.row}>
            <div className={classes.rowCol1}>Climate</div>
            <div className={classes.rowCol2}>{climate}</div>
          </div>
          <div className={classes.row}>
            <div className={classes.rowCol1}>Gravity</div>
            <div className={classes.rowCol2}>{gravity}</div>
          </div>
          <div className={classes.row}>
            <div className={classes.rowCol1}>Terrain</div>
            <div className={classes.rowCol2}>{terrain}</div>
          </div>
          <div className={classes.row}>
            <div className={classes.rowCol1}>Surface water</div>
            <div className={classes.rowCol2}>{surfaceWater}</div>
          </div>
          <div className={classes.row}>
            <div className={classes.rowCol1}>Population</div>
            <div className={classes.rowCol2}>{population}</div>
          </div>
        </div>
      </div>
    </div>
